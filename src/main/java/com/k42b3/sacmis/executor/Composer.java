 ...
 */
public class Composer extends ExecutorAbstract
{
	public Composer(String cmd, RSyntaxTextArea textArea)
	{
		super(cmd, textArea);
	}
	...
	{
		return new ExecutableDetector("--version", "Composer version");
	}
}
