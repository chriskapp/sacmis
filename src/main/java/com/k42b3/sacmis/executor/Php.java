 ...
 */
public class Php extends ExecutorAbstract
{
	public Php(String cmd, RSyntaxTextArea textArea)
	{
		super(cmd, textArea);
	}
	...
	{
		return new ExecutableDetector("--version", "PHP");
	}
}
